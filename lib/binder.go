...
type HTTPError struct{ echo.HTTPError }

var NewHTTPError = echo.NewHTTPError

func (cb *CustomBinder) Bind(i interface{}, c echo.Context) (err error) {
	if err = Bind(i, c); err != nil {
		return
	}
	return
}

func BindValidate(c echo.Context, i interface{}) (err error) {
	if err = Bind(i, c); err != nil {
		return
	}
...
func BindQueryParams(c echo.Context, i interface{}) error {
...
func BindBody(c echo.Context, i interface{}) (err error) {
	req := c.Request()
...
func bindData(destination interface{}, data map[string][]string, tag string) error {
	...
	for i := 0; i < typ.NumField(); i++ {
		...
		if inputFieldName == "" && defaultTag != tag {
			inputFieldName = typeField.Tag.Get(defaultTag)
		}
